        ...
        <div>
          <Skeleton className="bg-black flex justify-between text-white h-[200px] rounded-xl my-5 p-5">
            <div className="flex flex-col items-center justify-around">
              ...
              <Skeleton
                className={` w-12 h-12 rounded-full md:w-16 md:h-16 flex justify-center text-2xl text-black hover:bg-black hover:text-white hover:border-white duration-300 `}
              ></Skeleton>
            </div>
            <div className="flex flex-col items-center justify-around">
              <h3 className="text-sm sm:text-md md:text-lg xl:text-xl">
